...
public class LoadHttpClient {
	Logger logger = Logger.getLogger(LoadHttpClient.class);
	...
	public HttpClient _getUnderlyingHttpClient() {
		return httpClient;
	}
	...
	public LoadHttpClient(String urlBase, String username, String password)  throws Exception {
	...
	//HTTP POST request
	public String sendPOST(String url, Map<String, String> formData, String content, String contentType) throws Exception {
		HttpPost httpPost = new HttpPost(urlBase + url);
...
//            httpPost.setHeader("charset", "utf-8");
	...
	private static void finesseTest() throws Exception {
		String userId = "1002996";

		LoadHttpClient c = new LoadHttpClient("https://finesse25.autobot.cvp:8445/finesse/api/", userId, "cisco");
...
//		System.out.println("----- SET USER STATE ------\n" + c.sendPut("User/" + userId, "<User><state>READY</state></User>"));
	...
	private static void openfireTest() throws Exception {
		
		String content="<body ver='1.8' wait='60' xmpp:version='1.0' rid='1386962286239237' xmlns:xmpp='urn:xmpp:xbosh' hold='1' xml:lang='en' ack='1' to='finesse25.autobot.cvp' xmlns='http://jabber.org/protocol/httpbind'></body>";

		LoadHttpClient c = new LoadHttpClient("https://finesse25.autobot.cvp:7443/", "", "");
		
		System.out.println("----- RESPONSE of HTTP-BIND ------\n" + c.sendPOST("http-bind/", new HashMap(), content, "text/xml" ));
